...
export const ROUTES: RouteInfo[] = [
    { path: '/staff/classes', title: 'Class Management', icon: 'material-icons' },
    { path: '/classes/choose', title: 'Choose a Class', icon: 'material-icons' },
    { path: '/classes/students', title: 'Students', icon: 'material-icons' },
    { path: '/classes/tasks', title: 'Tasks', icon: 'material-icons' },
    ...
    { path: '/class/tasks', title: 'Tasks', icon: 'material-icons' },
