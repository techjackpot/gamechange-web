...
export const ROUTES: RouteInfo[] = [
    { path: '/staff/classes', title: 'Staff Management', icon: 'material-icons' },
    { path: '/classes/choose', title: 'Choose a Class', icon: 'material-icons' },
    { path: '/classes/students', title: 'Class Management', icon: 'material-icons' },
    { path: '/classes/tasks', title: 'Daily Task', icon: 'material-icons' },
    { path: '/classes/groups', title: 'Groups', icon: 'material-icons' },
    { path: '/classes/rollcall', title: 'Marks Management', icon: 'material-icons' },
